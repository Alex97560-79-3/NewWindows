...
export const ManagerDashboard: React.FC<ManagerDashboardProps> = ({
    ...
    const handlePrintPDF = () => {
        ...
        if (printWindow) {
            ...
            printWindow.document.write('<h1>Отчет по заказам (Менеджер)</h1>');
                            ...
                            <div className="flex flex-wrap justify-between items-start gap-4 mb-4 pb-4 border-b border-slate-200">
                                ...
                                <div className="text-right">
                                    ...
                                    <div className="mt-2 text-xs">
                                        Статус сборщика: <span className={`font-bold ${
                                            order.acceptanceStatus === 'Accepted' ? 'text-green-600' :
                             ...
                             <div className="mt-2">
                                 <button 
                                    ...
                                    onClick={() => onAddOrderComment(order.id, "Заказ проверен менеджером.", true, "Менеджер")}
                                 >
